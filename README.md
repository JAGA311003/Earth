...
git clone https://github.com/JAGA311003/Earth.git
...
But it can be helpful for either governments  or high-risk  installations (e.g. nuclear power plants) to plan and be in a better preparedness state.
